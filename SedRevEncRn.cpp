/**
 * @file
 * @brief Executes a single training run with the residual-recurrent architecture.
 *
 * Builds a residual-recurrent network, trainer, and optimizer and executes a single training run. Takes configuration, state, and
